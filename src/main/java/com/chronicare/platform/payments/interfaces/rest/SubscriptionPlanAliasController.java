...
/**
 * Alias controller for subscription plans with kebab-case URL
 * Frontend expects /api/v1/subscription-plans
 */
@RestController
@RequestMapping("/api/v1/subscription-plans")
@Tag(name = "Subscription Plans (Alias)", description = "Subscription Plans Management Endpoints - Kebab case alias")
public class SubscriptionPlanAliasController {

    private final SubscriptionPlanService subscriptionPlanService;

    public SubscriptionPlanAliasController(SubscriptionPlanService subscriptionPlanService) {
