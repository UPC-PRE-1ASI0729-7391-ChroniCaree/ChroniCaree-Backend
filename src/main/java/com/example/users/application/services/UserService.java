...
import com.example.users.infrastructure.persistence.JpaUserRepository;
...
public class UserService {
    ...
    public User register(RegisterUserCommand cmd) {
        ...
        events.publishEvent(
                new com.example.users.domain.events.UserRegisteredEvent(
                        this,
                        saved.getId(),
    ...
    public User update(UpdateUserCommand cmd) {
        ...
        events.publishEvent(new com.example.users.domain.events.UserUpdatedEvent(this, saved.getId()));
        return saved;
    }
    ...
    public void verify(VerifyUserCommand cmd) {
        ...
        events.publishEvent(new com.example.users.domain.events.UserVerifiedEvent(this, existing.getId()));
    }
